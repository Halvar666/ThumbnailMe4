...
About::About(QWidget *parent)
{
    ...
    QLabel *aboutLabel = new QLabel(this);
        ...
        aboutLabel->setText(
                            ...
                            "<p><b>Philippe Da Silva</b> :  Portugese translator - <a href=\"mailto:contact@philippedasilva.fr\">contact@philippedasilva.fr</a> - <a href=\"http://www.philippedasilva.fr\">www.philippedasilva.fr</a></p>"+
                            "<p><b>Qinlin Zha</b> :  Chinese translator - <a href=\"mailto:qinlin.zha@gmail.com\">qinlin.zha@gmail.com</a></p>"+
                            "<p><b>Dmitry Bochkov</b> :  Russian translator - <a href=\"mailto:translation@ukr.net\">translation@ukr.net</a></p>"+
                            "<h2>Websites :</h2><p>"+
    ...
    layout->addWidget(addHSeparator(),2,0);
